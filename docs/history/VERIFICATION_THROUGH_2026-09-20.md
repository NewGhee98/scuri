# Historical verification records — through 20 September 2026
...
## Historical record — Current verification — 20 September 2026
...
Evidence: `scuri-scroll-{before-tests,tests,typecheck,lint,build}.txt` (legacy artifact; see [evidence index](../evidence/README.md#legacy-local-artifacts)) and `SCURI_SCROLL_AND_DOCUMENTATION_2026-09-20.md`. Current release/architecture and the documentation inventory are in `PROJECT_CONTEXT.md` and `README.md`. Older counts and local-only statements below describe historical packages and must not be presented as current release status.

## Historical record — Four built-in panorama choices (historical local verification, 15 September)
...
## Historical record — Upload-checkpoint protection recovery (earlier local verification)
...
## Historical record — Zoom and arrangement suggestions (earlier local package)
...
## Historical record — Approved client release (earlier)
...
## Historical record — Earlier photo-sync patch
